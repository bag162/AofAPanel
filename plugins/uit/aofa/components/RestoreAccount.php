...
class RestoreAccount extends ComponentBase
{
    ...
    public function onRestoreAccount()
    {
        ...
        $restore_price = Settings::get('restore_price');
   
        $total = $data['account_count']*$restore_price;
